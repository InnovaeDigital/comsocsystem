    ...
    <>
        <div className="flex-1 flex flex-col lg:flex-row overflow-x-hidden">
          ...
          <div className="flex-1 p-3 sm:p-4 lg:p-8 overflow-y-auto space-y-6 sm:space-y-8 lg:space-y-12 min-w-0">
            ...
            {/* HUD PRINCIPAL */}
            <section className="bg-slate-900/60 border border-slate-800/80 p-4 sm:p-6 rounded-2xl sm:rounded-3xl relative overflow-hidden shadow-2xl backdrop-blur-sm">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 font-mono bg-slate-950/80 p-3 sm:p-4 rounded-2xl border border-slate-800 w-full md:w-auto">
                  <div>
              ...
              <div className="mt-6 pt-6 border-t border-slate-800/80 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 relative z-10">
                {isAdmin && (
            ...
            <nav className="sticky top-[5.25rem] z-30 bg-slate-950/90 border border-slate-800 rounded-2xl p-2 backdrop-blur-md shadow-xl">
                ...
                {workspaceTabs.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 rounded-xl border px-3 py-2 text-[10px] font-black uppercase tracking-wider transition-colors cursor-pointer ${
                        isActive
                          ? 'border-blue-500/50 bg-blue-600 text-white shadow-lg shadow-blue-950/40'
            ...
            <section id="atendimento" className={`${activeTab === 'atendimento' ? '' : 'hidden'} scroll-mt-32 bg-slate-900/70 border border-slate-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-2xl space-y-5`}>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4">
                  <p className="text-[9px] text-slate-500 uppercase font-black tracking-wider">Na fila</p>
                ...
                <div className="bg-red-950/35 border border-red-500/20 rounded-2xl p-4">
                  <p className="text-[9px] text-red-200/70 uppercase font-black tracking-wider">Criticos</p>
                  <p className="text-2xl font-black text-red-300 mt-1">{operationSummary.critical}</p>
                </div>
                <div className="bg-amber-950/35 border border-amber-500/20 rounded-2xl p-4">
                  <p className="text-[9px] text-amber-200/70 uppercase font-black tracking-wider">Em atraso</p>
                ...
                <div className="bg-blue-950/35 border border-blue-500/20 rounded-2xl p-4">
                  <p className="text-[9px] text-blue-200/70 uppercase font-black tracking-wider">Em execucao</p>
            ...
            <section className={`${activeTab === 'equipe' ? '' : 'hidden'} bg-slate-900/70 border border-slate-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-2xl space-y-5`}>
                ...
                {userActivityStats.map((stat) => (
                  <div key={stat.id} className="bg-slate-950 border border-slate-800 rounded-2xl p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-center">
                      <div className="bg-emerald-950/35 border border-emerald-500/20 rounded-xl p-3">
                      ...
                      <div className="bg-red-950/35 border border-red-500/20 rounded-xl p-3">
                      ...
                      <div className="bg-blue-950/35 border border-blue-500/20 rounded-xl p-3">
